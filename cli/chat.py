...
class InteractiveChat:
    ...
    def process_query(self, query: str) -> tuple:
        ...
        meta_rlm = MetaRecursiveRLM(self.rlm)
        result = meta_rlm.meta_solve(query, max_meta_depth=2)
...
"""
    ...
    def _analyze_repo(self, source: str, query: str = None):
        ...
        try:
            from cli.repo_analyzer import RepoAnalyzer
    ...
    def _analyze_url(self, url: str):
        ...
        try:
            ...
            try:
                ...
                from cli.repo_analyzer import html_to_text
    ...
    def _analyze_image(self, path_or_url: str):
        ...
        try:
            from src.extractors import describe_image, describe_image_url
